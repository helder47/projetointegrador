        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-4 is-offset-4">
                    <h3 class="title has-text-grey">Devolução de Livros</h3>
                    <?php  
                    ...
                    <div class="box">
                        <form action="devolver.php" method="POST">
                            ...
                            <div class="field">
                                <div class="control">
                                    <input name="aluno" class="input is-large" type="text" placeholder="Nome do aluno">
                                </div>
                            </div>
                            <button type="submit" class="button is-block is-link is-large is-fullwidth">Devolver</button>
                        </form>
                    </div>
                </div>
            </div>
